...
set CLASSPATH=%APP_HOME%\lib\Lab1-1.0.jar;%APP_HOME%\lib\log4j-core-2.8.2.jar;%APP_HOME%\lib\log4j-api-2.8.2.jar

@rem Execute Lab1
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LAB1_OPTS%  -classpath "%CLASSPATH%" Source %CMD_LINE_ARGS%
